...
class SimpleBasicModel(object):
  ...
  def __init__(self, name):
    ...
    self.save_dir = 'exp/cnn_pit/nnet'
  ...
  def decode(self, data, batch_size):
    ...
    for i in range(total_batch):
      ...
      pre = self.session.run(self.graph_node_dict[self.predict_nid],
  ...
  def train(self, data, batch_size, epoch, verbose=True):
    ...
    self.saver.save(self.session, os.path.join(self.save_dir, 'initial_model'))
